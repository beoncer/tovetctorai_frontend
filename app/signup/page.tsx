          ...
          <form className="p-6 md:p-8 bg-white">
            <div className="flex flex-col gap-6">
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-balance text-gray-600">Get started with your free account today</p>
              </div>
          ...
          <div className="relative hidden bg-gradient-to-br from-red-50 to-white md:block">
            <div className="absolute inset-0 flex items-center justify-center p-8">
              <div className="max-w-sm text-center">
                <h2 className="mb-4 text-2xl font-bold text-red-600">Start Creating Today</h2>
                <p className="text-gray-600">
                  Join thousands of users who are already transforming their images into professional vector graphics. Get your free preview today!
                </p>
              </div>
            </div>
          </div>
